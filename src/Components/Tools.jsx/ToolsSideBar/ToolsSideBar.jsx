            ...
            <ul className="space-y-2 sm:hidden xs:hidden xxs:hidden md:block lg:block">
              <li className="flex justify-between items-center bg-[#375744] dark:bg-gray-700 dark:hover:bg-gray-600 p-2 rounded-lg cursor-pointer transition-all duration-300">
                <button className="flex justify-between w-full">
                  ...
                  <span className="text-white dark:text-white font-medium">اسمدة</span>
                </button>
              </li>
              <li className="flex justify-between items-center bg-[#375744] dark:bg-gray-700 dark:hover:bg-gray-600 p-2 rounded-lg cursor-pointer transition-all duration-300">
                <button className="flex justify-between w-full">
                  <span className="text-white dark:text-gray-300">60</span>
                  <span className="text-white dark:text-white font-medium">اصص</span>
                </button>
              </li>
              <li className="flex justify-between items-center bg-[#375744] dark:bg-gray-700 dark:hover:bg-gray-600 p-2 rounded-lg cursor-pointer transition-all duration-300">
                <button className="flex justify-between w-full">
                  <span className="text-white dark:text-gray-300">70</span>
                  <span className="text-white dark:text-white font-medium">أدوات الحماية</span>
                </button>
              </li>
              <li className="flex justify-between items-center bg-[#375744] dark:bg-gray-700 dark:hover:bg-gray-600 p-2 rounded-lg cursor-pointer transition-all duration-300">
                <button className="flex justify-between w-full">
                  <span className="text-white dark:text-gray-300">10</span>
                  <span className="text-white dark:text-white font-medium">أدوات الري</span>
                </button>
              </li>
              <li className="flex justify-between items-center bg-[#375744] dark:bg-gray-700 dark:hover:bg-gray-600 p-2 rounded-lg cursor-pointer transition-all duration-300">
                <button className="flex justify-between w-full">
                  <span className="text-white dark:text-gray-300">40</span>
                  <span className="text-white dark:text-white font-medium">أدوات الحفر</span>
                </button>
              </li>
              <li className="flex justify-between items-center bg-[#375744] dark:bg-gray-700 dark:hover:bg-gray-600 p-2 rounded-lg cursor-pointer transition-all duration-300">
                <button className="flex justify-between w-full">
                  <span className="text-white dark:text-gray-300">40</span>
                  <span className="text-white dark:text-white font-medium">أدوات التقليم</span>
                </button>
              </li>
            </ul>
          </div>

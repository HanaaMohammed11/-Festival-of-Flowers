...
export default function Footer() {
  return (
    <div>
        <div className='my-auto bg-slate-700 w-full h-20 justify-center items-center flex'>
        <div className="flex gap-4 justify-center items-center">
      {/* WhatsApp Icon */}
      <a
        href="https://wa.me/"
        className="relative flex items-center justify-center w-[25%] text-white text-xl rounded-full transition-all duration-300 hover:bg-[#25D366] hover:scale-110"
      >
      ...
      <a
        ...
        className="relative flex items-center justify-center w-[25%]  text-white text-xl rounded-full transition-all duration-300 hover:bg-[#1877f2] hover:scale-110"
      >
        <svg
      ...
      <a
        ...
        className="relative flex items-center justify-center w-[25%]  text-white text-xl rounded-full transition-all duration-300 hover:bg-[#0077b5] hover:scale-110"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
